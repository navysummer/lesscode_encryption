...
impl LessCodeEncryption {
    ...
    #[staticmethod]
    #[pyo3(signature = (mode, data, key, iv=None))]
    fn sm4_encrypt(mode: String, data: String, key: String, iv: Option<String>) -> String {
        SMX::sm4_encrypt(mode, data, key, iv).unwrap()
    }
    #[staticmethod]
    #[pyo3(signature = (mode, data, key, iv=None))]
    fn sm4_decrypt(mode: String, data: String, key: String, iv: Option<String>) -> String {
